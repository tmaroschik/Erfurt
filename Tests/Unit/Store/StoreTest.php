...
namespace Erfurt\Tests\Unit\Store;
/***************************************************************
 *  Copyright notice
 *
...
class StoreTest extends \Erfurt\Tests\Unit\BaseTestCase {
	...
	public function testImportRdfFrom303Url() {
		...
		try {
			$store->importRdf($url, $url, 'auto', \Erfurt\Syntax_RdfParser::LOCATOR_URL, false);
		}
	...
	public function testDeleteMatchingStatementsMatchSubject() {
		...
		$store->importRdf($modelUri, $turtleString, 'turtle', \Erfurt\Syntax_RdfParser::LOCATOR_DATASTRING, false);
	...
	public function testCheckSetupWithZendDb() {
		...
		$store = \Erfurt\App::getInstance()->getStore();
		$config = \Erfurt\App::getInstance()->getConfig();
	...
	public function testSparqlQueryWithCountQueryAndEmptyResultIssue174() {
		...
		$simpleQuery = \Erfurt\Sparql\SimpleQuery::initWithString($query);
	...
	public function testSparqlQueryWithSpecialCharUriIssue579() {
		...
		$simpleQuery = \Erfurt\Sparql\SimpleQuery::initWithString($sparql);
		$result = $store->sparqlQuery($simpleQuery);
