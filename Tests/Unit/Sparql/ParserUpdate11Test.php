...
class ParserUpdate11Test extends \Erfurt\Tests\Unit\BaseTestCase {
	...
	public function testParse($querySpec) {
		$parser = new \Erfurt\Sparql\Parser\Sparql11update();
		try {
			...
			$this->assertTrue($q instanceof \Erfurt\Sparql_Query2);
		}
		catch (\Exception $e) {
