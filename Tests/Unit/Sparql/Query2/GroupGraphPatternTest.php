...
class GroupGraphPatternTest extends \Erfurt\Tests\Unit\BaseTestCase {
	...
	public function setUp() {
		$this->pattern = new \Erfurt\Sparql\Query2\GroupGraphPattern();
	}

	public function testTripleSeprator() {
		$x = new \Erfurt\Sparql\Query2\Variable("x");
		$triple = new \Erfurt\Sparql\Query2\Triple($x, $x, $x);
	...
	public function testRemoveOptionals() {
		$x = new \Erfurt\Sparql\Query2\Variable("x");
		$triple = new \Erfurt\Sparql\Query2\Triple($x, $x, $x);
		$optional = new \Erfurt\Sparql\Query2\OptionalGraphPattern();
