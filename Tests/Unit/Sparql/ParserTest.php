...
class ParserTest extends \Erfurt\Tests\Unit\BaseTestCase {
	...
	public function setUp() {
		$this->_parser = new \Erfurt\Sparql\Parser();
	}
	...
	public function testTokenize() {
		...
		$this->assertEquals($tokens, \Erfurt\Sparql\Parser::tokenize($tokenString));
	}
	...
	public function testUncomment() {
		...
		$this->assertEquals('', trim(\Erfurt\Sparql\Parser::uncomment($queryString)));
	}
	...
	public function testParse($querySpec) {
		...
		try {
			...
			$this->assertTrue($queryObject instanceof \Erfurt\Sparql\Query);
		}
		catch (\Exception $e) {
