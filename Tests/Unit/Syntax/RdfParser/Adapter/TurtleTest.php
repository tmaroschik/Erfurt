 ...
 ***************************************************************/
class TurtleTest extends \Erfurt\Tests\Unit\BaseTestCase {

	const SYNTAX_TEST_DIR = 'resources/syntax/valid/';

	/**
	 * @var \Erfurt\Syntax\RdfParser\Adapter\Turtle
	 * @access protected
	 */
	protected $_object;
	...
	protected function setUp() {
		$this->_object = new \Erfurt\Syntax\RdfParser\Adapter\Turtle();
	}
