 ...
 */
class VersioningTest extends \Erfurt\Tests\Unit\BaseTestCase {

	/**
	 * @var \Erfurt\Versioning
	 * @access protected
	 */
	protected $_object;
	...
	protected function setUp() {
		$this->_storeStub = new \Erfurt\Tests\Unit\Versioning\StoreStub();
		$this->_authStub = new \Erfurt\Tests\Unit\Versioning\AuthStub();
	...
	protected function _getMockedVersioning() {
		...
		$versioning = $this->getMock('\Erfurt\Versioning\Versioning',
	...
	public function testIsActionStartedAfterStartAction() {
		$this->_object->startAction(\Erfurt\Versioning\Versioning::MODEL_IMPORTED);

		$this->assertTrue($this->_object->isActionStarted());
	}

	public function testIsActionStartedAfterStartAndEndAction() {
		$this->_object->startAction(\Erfurt\Versioning\Versioning::STATEMENT_REMOVED);
	...
	public function testStartActionWhileActionIsRunning() {
		try {
			$this->_object->startAction(\Erfurt\Versioning\Versioning::STATEMENT_ADDED);
	...
	public function testOnAddStatement() {
		...
		$event = new \Erfurt\Event('onAddStatement');
	...
	public function testOnAddMultipleStatements() {
		...
		require_once 'Erfurt/Event.php';
		$event = new \Erfurt\Event('onAddMultipleStatements');
		$event->graphUri = 'http://example.org/';
	...
	public function testOnDeleteMatchingStatements() {
		...
		require_once 'Erfurt/Event.php';
		$event = new \Erfurt\Event('onDeleteMatchingStatements');
		$event->graphUri = 'http://example.org/';
	...
	public function testOnDeleteMultipleStatements() {
		...
		require_once 'Erfurt/Event.php';
		$event = new \Erfurt\Event('onDeleteMultipleStatements');
		$event->graphUri = 'http://example.org/';
