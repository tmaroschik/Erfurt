 ...
 * @scope prototype
 */
class PhpFrontend extends \Erfurt\Cache\Frontend\StringFrontend {

	/**
	 * Constructs the cache
	 *
	 * @param string $identifier A identifier which describes this cache
	 * @param \Erfurt\Cache\Backend\PhpCapableBackendInterface $backend Backend to be used for this cache
	 * @author Robert Lemke <robert@typo3.org>
	 */
	public function __construct($identifier, \Erfurt\Cache\Backend\PhpCapableBackendInterface $backend) {
	...
	public function set($entryIdentifier, $sourceCode, array $tags = array(), $lifetime = NULL) {
		...
		if (!is_string($sourceCode)) throw new \Erfurt\Cache\Exception\InvalidDataException('The given source code is not a valid string.', 1264023824);
		foreach ($tags as $tag) {
