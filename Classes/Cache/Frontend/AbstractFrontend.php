 ...
 * @scope prototype
 */
abstract class AbstractFrontend implements \Erfurt\Cache\Frontend\FrontendInterface {
	...
	/**
	 * @var \Erfurt\Cache\Backend\AbstractBackend
	 */
	protected $backend;
	 ...
	 * @param \Erfurt\Cache\Backend\BackendInterface $backend Backend to be used for this cache
	 * @author Robert Lemke <robert@typo3.org>
	 * @throws \InvalidArgumentException if the identifier doesn't match PATTERN_ENTRYIDENTIFIER
	 */
	public function __construct($identifier, \Erfurt\Cache\Backend\BackendInterface $backend) {
	 ...
	 *
	 * @return \Erfurt\Cache\Backend\BackendInterface The backend used by this cache
	 * @author Robert Lemke <robert@typo3.org>
	 * @api
	 */
