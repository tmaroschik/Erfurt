 ...
 * @scope prototype
 */
class TransientMemoryBackend extends \Erfurt\Cache\Backend\AbstractBackend {
	...
	public function set($entryIdentifier, $data, array $tags = array(), $lifetime = NULL) {
		if (!$this->cache instanceof \Erfurt\Cache\Frontend\FrontendInterface) throw new \Erfurt\Cache\Exception('No cache frontend has been set yet via setCache().', 1238244992);
		if (!is_string($data)) throw new \Erfurt\Cache\Exception\InvalidDataException('The specified data is of type "' . gettype($data) . '" but a string is expected.', 1238244993);
