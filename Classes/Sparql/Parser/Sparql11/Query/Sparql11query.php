...
namespace Erfurt\Sparql\Parser\Sparql11\Query;
	...
	public function orderCondition() {
		try {
			...
			if ((($LA23_0 >= $this->getToken('ASC') && $LA23_0 <= $this->getToken('DESC')))) {
				...
				if (($LA23_0 == $this->getToken('COALESCE') || $LA23_0 == $this->getToken('IF') || ($LA23_0 >= $this->getToken('STR') && $LA23_0 <= $this->getToken('REGEX')) || $LA23_0 == $this->getToken('IRI_REF') || $LA23_0 == $this->getToken('PNAME_NS') || $LA23_0 == $this->getToken('PNAME_LN') || ($LA23_0 >= $this->getToken('VAR1') && $LA23_0 <= $this->getToken('VAR2')) || $LA23_0 == $this->getToken('OPEN_BRACE'))) {
					$alt23 = 2;
				}
				else {
			...
			switch ($alt23) {
				...
				case 2 :
					...
					if (($LA22_0 == $this->getToken('COALESCE') || $LA22_0 == $this->getToken('IF') || ($LA22_0 >= $this->getToken('STR') && $LA22_0 <= $this->getToken('REGEX')) || $LA22_0 == $this->getToken('IRI_REF') || $LA22_0 == $this->getToken('PNAME_NS') || $LA22_0 == $this->getToken('PNAME_LN') || $LA22_0 == $this->getToken('OPEN_BRACE'))) {
						...
						if ((($LA22_0 >= $this->getToken('VAR1') && $LA22_0 <= $this->getToken('VAR2')))) {
							$alt22 = 2;
						}
						else {
	...
	public function graphPatternNotTriples() {
		try {
			...
			if ($this->getToken('OPTIONAL') == $LA26) {
				...
				if ($this->getToken('OPEN_CURLY_BRACE') == $LA26) {
					$alt26 = 2;
				}
				else {
					if ($this->getToken('GRAPH') == $LA26) {
						$alt26 = 3;
					}
					else {
						$nvae =
		...
		try {
			...
			if (($LA31_0 == $this->getToken('OPEN_BRACE'))) {
				...
				if (($LA31_1 == $this->getToken('COALESCE') || $LA31_1 == $this->getToken('IF') || ($LA31_1 >= $this->getToken('STR') && $LA31_1 <= $this->getToken('FALSE')) || $LA31_1 == $this->getToken('IRI_REF') || $LA31_1 == $this->getToken('PNAME_NS') || $LA31_1 == $this->getToken('PNAME_LN') || ($LA31_1 >= $this->getToken('VAR1') && $LA31_1 <= $this->getToken('MINUS')) || $LA31_1 == $this->getToken('INTEGER') || $LA31_1 == $this->getToken('DECIMAL') || ($LA31_1 >= $this->getToken('DOUBLE') && $LA31_1 <= $this->getToken('DOUBLE_NEGATIVE')) || ($LA31_1 >= $this->getToken('STRING_LITERAL1') && $LA31_1 <= $this->getToken('STRING_LITERAL_LONG2')) || $LA31_1 == $this->getToken('NOT_SIGN') || $LA31_1 == $this->getToken('OPEN_BRACE'))) {
					...
					if (($LA31_1 == $this->getToken('WS') || $LA31_1 == $this->getToken('CLOSE_BRACE'))) {
						$alt31 = 1;
					}
					else {
			...
			if ($this->getToken('TRUE') == $LA35 || $this->getToken('FALSE') == $LA35 || $this->getToken('IRI_REF') == $LA35 || $this->getToken('PNAME_NS') == $LA35 || $this->getToken('PNAME_LN') == $LA35 || $this->getToken('VAR1') == $LA35 || $this->getToken('VAR2') == $LA35 || $this->getToken('INTEGER') == $LA35 || $this->getToken('DECIMAL') == $LA35 || $this->getToken('DOUBLE') == $LA35 || $this->getToken('INTEGER_POSITIVE') == $LA35 || $this->getToken('DECIMAL_POSITIVE') == $LA35 || $this->getToken('DOUBLE_POSITIVE') == $LA35 || $this->getToken('INTEGER_NEGATIVE') == $LA35 || $this->getToken('DECIMAL_NEGATIVE') == $LA35 || $this->getToken('DOUBLE_NEGATIVE') == $LA35 || $this->getToken('STRING_LITERAL1') == $LA35 || $this->getToken('STRING_LITERAL2') == $LA35 || $this->getToken('STRING_LITERAL_LONG1') == $LA35 || $this->getToken('STRING_LITERAL_LONG2') == $LA35 || $this->getToken('BLANK_NODE_LABEL') == $LA35) {
				...
				if ($this->getToken('OPEN_SQUARE_BRACE') == $LA35) {
					...
					if (($LA35_2 == $this->getToken('WS') || $LA35_2 == $this->getToken('CLOSE_SQUARE_BRACE'))) {
						...
						if (($LA35_2 == $this->getToken('A') || $LA35_2 == $this->getToken('IRI_REF') || $LA35_2 == $this->getToken('PNAME_NS') || $LA35_2 == $this->getToken('PNAME_LN') || ($LA35_2 >= $this->getToken('VAR1') && $LA35_2 <= $this->getToken('VAR2')))) {
							$alt35 = 2;
						}
						else {
					...
					if ($this->getToken('OPEN_BRACE') == $LA35) {
						...
						if ((($LA35_3 >= $this->getToken('TRUE') && $LA35_3 <= $this->getToken('FALSE')) || $LA35_3 == $this->getToken('IRI_REF') || $LA35_3 == $this->getToken('PNAME_NS') || $LA35_3 == $this->getToken('PNAME_LN') || ($LA35_3 >= $this->getToken('VAR1') && $LA35_3 <= $this->getToken('VAR2')) || $LA35_3 == $this->getToken('INTEGER') || $LA35_3 == $this->getToken('DECIMAL') || $LA35_3 == $this->getToken('DOUBLE') || ($LA35_3 >= $this->getToken('INTEGER_POSITIVE') && $LA35_3 <= $this->getToken('DOUBLE_NEGATIVE')) || ($LA35_3 >= $this->getToken('STRING_LITERAL1') && $LA35_3 <= $this->getToken('STRING_LITERAL_LONG2')) || $LA35_3 == $this->getToken('BLANK_NODE_LABEL') || $LA35_3 == $this->getToken('OPEN_BRACE') || $LA35_3 == $this->getToken('OPEN_SQUARE_BRACE'))) {
							...
							if (($LA35_3 == $this->getToken('WS') || $LA35_3 == $this->getToken('CLOSE_BRACE'))) {
								$alt35 = 1;
							}
							else {
	...
	public function triplesNode() {
		try {
			...
			if (($LA41_0 == $this->getToken('OPEN_BRACE'))) {
				...
				if (($LA41_0 == $this->getToken('OPEN_SQUARE_BRACE'))) {
					$alt41 = 2;
				}
				else {
			...
			if ($this->getToken('TRUE') == $LA43 || $this->getToken('FALSE') == $LA43 || $this->getToken('IRI_REF') == $LA43 || $this->getToken('PNAME_NS') == $LA43 || $this->getToken('PNAME_LN') == $LA43 || $this->getToken('VAR1') == $LA43 || $this->getToken('VAR2') == $LA43 || $this->getToken('INTEGER') == $LA43 || $this->getToken('DECIMAL') == $LA43 || $this->getToken('DOUBLE') == $LA43 || $this->getToken('INTEGER_POSITIVE') == $LA43 || $this->getToken('DECIMAL_POSITIVE') == $LA43 || $this->getToken('DOUBLE_POSITIVE') == $LA43 || $this->getToken('INTEGER_NEGATIVE') == $LA43 || $this->getToken('DECIMAL_NEGATIVE') == $LA43 || $this->getToken('DOUBLE_NEGATIVE') == $LA43 || $this->getToken('STRING_LITERAL1') == $LA43 || $this->getToken('STRING_LITERAL2') == $LA43 || $this->getToken('STRING_LITERAL_LONG1') == $LA43 || $this->getToken('STRING_LITERAL_LONG2') == $LA43 || $this->getToken('BLANK_NODE_LABEL') == $LA43) {
				...
				if ($this->getToken('OPEN_SQUARE_BRACE') == $LA43) {
					...
					if (($LA43_2 == $this->getToken('WS') || $LA43_2 == $this->getToken('CLOSE_SQUARE_BRACE'))) {
						...
						if (($LA43_2 == $this->getToken('A') || $LA43_2 == $this->getToken('IRI_REF') || $LA43_2 == $this->getToken('PNAME_NS') || $LA43_2 == $this->getToken('PNAME_LN') || ($LA43_2 >= $this->getToken('VAR1') && $LA43_2 <= $this->getToken('VAR2')))) {
							$alt43 = 2;
						}
						else {
					...
					if ($this->getToken('OPEN_BRACE') == $LA43) {
						...
						if ((($LA43_3 >= $this->getToken('TRUE') && $LA43_3 <= $this->getToken('FALSE')) || $LA43_3 == $this->getToken('IRI_REF') || $LA43_3 == $this->getToken('PNAME_NS') || $LA43_3 == $this->getToken('PNAME_LN') || ($LA43_3 >= $this->getToken('VAR1') && $LA43_3 <= $this->getToken('VAR2')) || $LA43_3 == $this->getToken('INTEGER') || $LA43_3 == $this->getToken('DECIMAL') || $LA43_3 == $this->getToken('DOUBLE') || ($LA43_3 >= $this->getToken('INTEGER_POSITIVE') && $LA43_3 <= $this->getToken('DOUBLE_NEGATIVE')) || ($LA43_3 >= $this->getToken('STRING_LITERAL1') && $LA43_3 <= $this->getToken('STRING_LITERAL_LONG2')) || $LA43_3 == $this->getToken('BLANK_NODE_LABEL') || $LA43_3 == $this->getToken('OPEN_BRACE') || $LA43_3 == $this->getToken('OPEN_SQUARE_BRACE'))) {
							...
							if (($LA43_3 == $this->getToken('WS') || $LA43_3 == $this->getToken('CLOSE_BRACE'))) {
								$alt43 = 1;
							}
							else {
	...
	public function varOrIRIref() {
		try {
			...
			if ((($LA45_0 >= $this->getToken('VAR1') && $LA45_0 <= $this->getToken('VAR2')))) {
				...
				if (($LA45_0 == $this->getToken('IRI_REF') || $LA45_0 == $this->getToken('PNAME_NS') || $LA45_0 == $this->getToken('PNAME_LN'))) {
					$alt45 = 2;
				}
				else {
	...
	public function graphTerm() {
		try {
			...
			if ($this->getToken('IRI_REF') == $LA47 || $this->getToken('PNAME_NS') == $LA47 || $this->getToken('PNAME_LN') == $LA47) {
				...
				if ($this->getToken('STRING_LITERAL1') == $LA47 || $this->getToken('STRING_LITERAL2') == $LA47 || $this->getToken('STRING_LITERAL_LONG1') == $LA47 || $this->getToken('STRING_LITERAL_LONG2') == $LA47) {
					$alt47 = 2;
				}
				else {
					if ($this->getToken('INTEGER') == $LA47 || $this->getToken('DECIMAL') == $LA47 || $this->getToken('DOUBLE') == $LA47 || $this->getToken('INTEGER_POSITIVE') == $LA47 || $this->getToken('DECIMAL_POSITIVE') == $LA47 || $this->getToken('DOUBLE_POSITIVE') == $LA47 || $this->getToken('INTEGER_NEGATIVE') == $LA47 || $this->getToken('DECIMAL_NEGATIVE') == $LA47 || $this->getToken('DOUBLE_NEGATIVE') == $LA47) {
						$alt47 = 3;
					}
					else {
						if ($this->getToken('TRUE') == $LA47 || $this->getToken('FALSE') == $LA47) {
							$alt47 = 4;
						}
						else {
							if ($this->getToken('BLANK_NODE_LABEL') == $LA47 || $this->getToken('OPEN_SQUARE_BRACE') == $LA47) {
								$alt47 = 5;
							}
							else {
								if ($this->getToken('OPEN_BRACE') == $LA47) {
									$alt47 = 6;
								}
								else {
									$nvae =
		...
		try {
			...
			// Sparql11query.g:404:3: numericExpression ( EQUAL numericExpression | NOT_EQUAL numericExpression | LESS numericExpression | GREATER numericExpression | LESS_EQUAL numericExpression | GREATER_EQUAL numericExpression )?
			{
				...
				if ($this->getToken('EQUAL') == $LA50) {
					...
					if ($this->getToken('NOT_EQUAL') == $LA50) {
						$alt50 = 2;
					}
					else {
						if ($this->getToken('LESS') == $LA50) {
							$alt50 = 3;
						}
						else {
							if ($this->getToken('GREATER') == $LA50) {
								$alt50 = 4;
							}
							else {
								if ($this->getToken('LESS_EQUAL') == $LA50) {
									$alt50 = 5;
								}
								else {
									if ($this->getToken('GREATER_EQUAL') == $LA50) {
										$alt50 = 6;
									}
								}
							}
			...
			// Sparql11query.g:426:3: multiplicativeExpression ( PLUS multiplicativeExpression | MINUS multiplicativeExpression | numericLiteralPositive | numericLiteralNegative )*
			{
				...
				do {
					...
					if ($this->getToken('PLUS') == $LA51) {
						...
						if ($this->getToken('MINUS') == $LA51) {
							$alt51 = 2;
						}
						else {
							if ($this->getToken('INTEGER_POSITIVE') == $LA51 || $this->getToken('DECIMAL_POSITIVE') == $LA51 || $this->getToken('DOUBLE_POSITIVE') == $LA51) {
								$alt51 = 3;
							}
							else {
								if ($this->getToken('INTEGER_NEGATIVE') == $LA51 || $this->getToken('DECIMAL_NEGATIVE') == $LA51 || $this->getToken('DOUBLE_NEGATIVE') == $LA51) {
									$alt51 = 4;
								}
							}
						}
			...
			// Sparql11query.g:439:3: unaryExpression ( ASTERISK unaryExpression | DIVIDE unaryExpression )*
			{
				...
				do {
					...
					if (($LA52_0 == $this->getToken('ASTERISK'))) {
						...
						if (($LA52_0 == $this->getToken('DIVIDE'))) {
							$alt52 = 2;
						}
					}
					switch ($alt52) {
	...
	public function unaryExpression() {
		try {
			...
			if ($this->getToken('NOT_SIGN') == $LA53) {
				...
				if ($this->getToken('PLUS') == $LA53) {
					$alt53 = 2;
				}
				else {
					if ($this->getToken('MINUS') == $LA53) {
						$alt53 = 3;
					}
					else {
						if ($this->getToken('COALESCE') == $LA53 || $this->getToken('IF') == $LA53 || $this->getToken('STR') == $LA53 || $this->getToken('LANG') == $LA53 || $this->getToken('LANGMATCHES') == $LA53 || $this->getToken('DATATYPE') == $LA53 || $this->getToken('BOUND') == $LA53 || $this->getToken('SAMETERM') == $LA53 || $this->getToken('ISIRI') == $LA53 || $this->getToken('ISURI') == $LA53 || $this->getToken('ISBLANK') == $LA53 || $this->getToken('ISLITERAL') == $LA53 || $this->getToken('REGEX') == $LA53 || $this->getToken('TRUE') == $LA53 || $this->getToken('FALSE') == $LA53 || $this->getToken('IRI_REF') == $LA53 || $this->getToken('PNAME_NS') == $LA53 || $this->getToken('PNAME_LN') == $LA53 || $this->getToken('VAR1') == $LA53 || $this->getToken('VAR2') == $LA53 || $this->getToken('INTEGER') == $LA53 || $this->getToken('DECIMAL') == $LA53 || $this->getToken('DOUBLE') == $LA53 || $this->getToken('INTEGER_POSITIVE') == $LA53 || $this->getToken('DECIMAL_POSITIVE') == $LA53 || $this->getToken('DOUBLE_POSITIVE') == $LA53 || $this->getToken('INTEGER_NEGATIVE') == $LA53 || $this->getToken('DECIMAL_NEGATIVE') == $LA53 || $this->getToken('DOUBLE_NEGATIVE') == $LA53 || $this->getToken('STRING_LITERAL1') == $LA53 || $this->getToken('STRING_LITERAL2') == $LA53 || $this->getToken('STRING_LITERAL_LONG1') == $LA53 || $this->getToken('STRING_LITERAL_LONG2') == $LA53 || $this->getToken('OPEN_BRACE') == $LA53) {
							$alt53 = 4;
						}
						else {
							$nvae =
	...
	public function primaryExpression() {
		try {
			...
			if ($this->getToken('OPEN_BRACE') == $LA54) {
				...
				if ($this->getToken('COALESCE') == $LA54 || $this->getToken('IF') == $LA54 || $this->getToken('STR') == $LA54 || $this->getToken('LANG') == $LA54 || $this->getToken('LANGMATCHES') == $LA54 || $this->getToken('DATATYPE') == $LA54 || $this->getToken('BOUND') == $LA54 || $this->getToken('SAMETERM') == $LA54 || $this->getToken('ISIRI') == $LA54 || $this->getToken('ISURI') == $LA54 || $this->getToken('ISBLANK') == $LA54 || $this->getToken('ISLITERAL') == $LA54 || $this->getToken('REGEX') == $LA54) {
					$alt54 = 2;
				}
				else {
					if ($this->getToken('IRI_REF') == $LA54 || $this->getToken('PNAME_NS') == $LA54 || $this->getToken('PNAME_LN') == $LA54) {
						...
						if ($this->getToken('STRING_LITERAL1') == $LA54 || $this->getToken('STRING_LITERAL2') == $LA54 || $this->getToken('STRING_LITERAL_LONG1') == $LA54 || $this->getToken('STRING_LITERAL_LONG2') == $LA54) {
							$alt54 = 4;
						}
						else {
							if ($this->getToken('INTEGER') == $LA54 || $this->getToken('DECIMAL') == $LA54 || $this->getToken('DOUBLE') == $LA54 || $this->getToken('INTEGER_POSITIVE') == $LA54 || $this->getToken('DECIMAL_POSITIVE') == $LA54 || $this->getToken('DOUBLE_POSITIVE') == $LA54 || $this->getToken('INTEGER_NEGATIVE') == $LA54 || $this->getToken('DECIMAL_NEGATIVE') == $LA54 || $this->getToken('DOUBLE_NEGATIVE') == $LA54) {
								$alt54 = 5;
							}
							else {
								if ($this->getToken('TRUE') == $LA54 || $this->getToken('FALSE') == $LA54) {
									$alt54 = 6;
								}
								else {
									if ($this->getToken('VAR1') == $LA54 || $this->getToken('VAR2') == $LA54) {
										$alt54 = 7;
									}
									else {
										$nvae =
	...
	public function builtInCall() {
		try {
			...
			if ($this->getToken('STR') == $LA55) {
				...
				if ($this->getToken('LANG') == $LA55) {
					$alt55 = 2;
				}
				else {
					if ($this->getToken('LANGMATCHES') == $LA55) {
						$alt55 = 3;
					}
					else {
						if ($this->getToken('DATATYPE') == $LA55) {
							$alt55 = 4;
						}
						else {
							if ($this->getToken('BOUND') == $LA55) {
								$alt55 = 5;
							}
							else {
								if ($this->getToken('COALESCE') == $LA55) {
									$alt55 = 6;
								}
								else {
									if ($this->getToken('IF') == $LA55) {
										$alt55 = 7;
									}
									else {
										if ($this->getToken('SAMETERM') == $LA55) {
											$alt55 = 8;
										}
										else {
											if ($this->getToken('ISIRI') == $LA55) {
												$alt55 = 9;
											}
											else {
												if ($this->getToken('ISURI') == $LA55) {
													$alt55 = 10;
												}
												else {
													if ($this->getToken('ISBLANK') == $LA55) {
														$alt55 = 11;
													}
													else {
														if ($this->getToken('ISLITERAL') == $LA55) {
															$alt55 = 12;
														}
														else {
															if ($this->getToken('REGEX') == $LA55) {
																$alt55 = 13;
															}
															else {
																$nvae =
		...
		try {
			...
			// Sparql11query.g:532:3: string ( LANGTAG | ( REFERENCE iriRef ) )?
			{
				...
				if (($LA58_0 == $this->getToken('LANGTAG'))) {
					...
					if (($LA58_0 == $this->getToken('REFERENCE'))) {
						$alt58 = 2;
					}
				}
				switch ($alt58) {
	...
	public function numericLiteral() {
		try {
			...
			if ($this->getToken('INTEGER') == $LA59 || $this->getToken('DECIMAL') == $LA59 || $this->getToken('DOUBLE') == $LA59) {
				...
				if ($this->getToken('INTEGER_POSITIVE') == $LA59 || $this->getToken('DECIMAL_POSITIVE') == $LA59 || $this->getToken('DOUBLE_POSITIVE') == $LA59) {
					$alt59 = 2;
				}
				else {
					if ($this->getToken('INTEGER_NEGATIVE') == $LA59 || $this->getToken('DECIMAL_NEGATIVE') == $LA59 || $this->getToken('DOUBLE_NEGATIVE') == $LA59) {
						$alt59 = 3;
					}
					else {
						$nvae =
	...
	public function iriRef() {
		try {
			...
			if (($LA60_0 == $this->getToken('IRI_REF'))) {
				...
				if (($LA60_0 == $this->getToken('PNAME_NS') || $LA60_0 == $this->getToken('PNAME_LN'))) {
					$alt60 = 2;
				}
				else {
	...
	public function blankNode() {
		try {
			...
			if (($LA62_0 == $this->getToken('BLANK_NODE_LABEL'))) {
				...
				if (($LA62_0 == $this->getToken('OPEN_SQUARE_BRACE'))) {
					$alt62 = 2;
				}
				else {
					...
					switch ($alt68) {
						case 1 :
							...
							if ((($LA65_0 >= $this->getToken('OPTIONAL') && $LA65_0 <= $this->getToken('GRAPH')) || $LA65_0 == $this->getToken('OPEN_CURLY_BRACE'))) {
								...
								if (($LA65_0 == $this->getToken('FILTER'))) {
									$alt65 = 2;
								}
								else {
		...
		try {
			...
			// Sparql11query.g:653:3: SELECT ( DISTINCT | REDUCED )? ( ASTERISK | ( variable | builtInCall | functionCall | ( OPEN_BRACE expression ( AS variable )? CLOSE_BRACE )+ ) )
			{
				...
				if (($LA73_0 == $this->getToken('ASTERISK'))) {
					...
					if (($LA73_0 == $this->getToken('COALESCE') || $LA73_0 == $this->getToken('IF') || ($LA73_0 >= $this->getToken('STR') && $LA73_0 <= $this->getToken('REGEX')) || $LA73_0 == $this->getToken('IRI_REF') || $LA73_0 == $this->getToken('PNAME_NS') || $LA73_0 == $this->getToken('PNAME_LN') || ($LA73_0 >= $this->getToken('VAR1') && $LA73_0 <= $this->getToken('VAR2')) || $LA73_0 == $this->getToken('OPEN_BRACE'))) {
						$alt73 = 2;
					}
					else {
				...
				switch ($alt73) {
					...
					case 2 :
						...
						if ($this->getToken('VAR1') == $LA72 || $this->getToken('VAR2') == $LA72) {
							...
							if ($this->getToken('COALESCE') == $LA72 || $this->getToken('IF') == $LA72 || $this->getToken('STR') == $LA72 || $this->getToken('LANG') == $LA72 || $this->getToken('LANGMATCHES') == $LA72 || $this->getToken('DATATYPE') == $LA72 || $this->getToken('BOUND') == $LA72 || $this->getToken('SAMETERM') == $LA72 || $this->getToken('ISIRI') == $LA72 || $this->getToken('ISURI') == $LA72 || $this->getToken('ISBLANK') == $LA72 || $this->getToken('ISLITERAL') == $LA72 || $this->getToken('REGEX') == $LA72) {
								$alt72 = 2;
							}
							else {
								if ($this->getToken('IRI_REF') == $LA72 || $this->getToken('PNAME_NS') == $LA72 || $this->getToken('PNAME_LN') == $LA72) {
									$alt72 = 3;
								}
								else {
									if ($this->getToken('OPEN_BRACE') == $LA72) {
										$alt72 = 4;
									}
									else {
										$nvae =
