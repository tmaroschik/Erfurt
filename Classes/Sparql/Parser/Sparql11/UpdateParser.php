...
class UpdateParser extends \AntlrParser {
	...
	public function __construct($input, $state = null) {
		...
		$this->gSparql10 = new Update\Sparql10($input, $state, $this);
		$this->gSparql11update = new Update\Sparql11update($input, $state, $this);

	}

	public function getTokenNames() {
		return UpdateParser::$tokenNames;
	}

	public function getGrammarFileName() {
		return "/Users/roll/Documents/workspace/SparqlGrammar/src/Erfurt_Sparql_Parser_Sparql11_Update.g";
	}
	...
	public function path() {
		$this->gSparql11update->path();
	}

	public function load() {
		$this->gSparql11update->load();
	}

	public function pathMod() {
		$this->gSparql11update->pathMod();
	}

	public function propertyListNotEmptyPath() {
		$this->gSparql11update->propertyListNotEmptyPath();
	}
	...
	public function delete() {
		$this->gSparql11update->delete();
	}

	public function insertTemplate() {
		$this->gSparql11update->insertTemplate();
	}

	public function update() {
		$this->gSparql11update->update();
	}
	...
	public function updateUnit() {
		$this->gSparql11update->updateUnit();
	}
	...
	public function updatePattern() {
		$this->gSparql11update->updatePattern();
	}
	...
	public function triplesSameSubjectPath() {
		$this->gSparql11update->triplesSameSubjectPath();
	}
	...
	public function pathPrimary() {
		$this->gSparql11update->pathPrimary();
	}

	public function pathEltOrReverse() {
		$this->gSparql11update->pathEltOrReverse();
	}
	...
	public function propertyListPath() {
		$this->gSparql11update->propertyListPath();
	}
	...
	public function pathAlternative() {
		$this->gSparql11update->pathAlternative();
	}

	public function pathElt() {
		$this->gSparql11update->pathElt();
	}
	...
	public function aggregate() {
		$this->gSparql11update->aggregate();
	}

	public function groupGraphPatternSub() {
		$this->gSparql11update->groupGraphPatternSub();
	}
	...
	public function deleteData() {
		$this->gSparql11update->deleteData();
	}
	...
	public function verbSimple() {
		$this->gSparql11update->verbSimple();
	}
	...
	public function create() {
		$this->gSparql11update->create();
	}

	public function existsFunc() {
		$this->gSparql11update->existsFunc();
	}

	public function pathSequence() {
		$this->gSparql11update->pathSequence();
	}
	...
	public function notExistsFunc() {
		$this->gSparql11update->notExistsFunc();
	}
	...
	public function deleteTemplate() {
		$this->gSparql11update->deleteTemplate();
	}

	public function insertData() {
		$this->gSparql11update->insertData();
	}

	public function verbPath() {
		$this->gSparql11update->verbPath();
	}
...
UpdateParser::$FOLLOW_updateUnit_in_parse39 = new Set(array());
UpdateParser::$FOLLOW_EOF_in_parse41 = new Set(array(1));
