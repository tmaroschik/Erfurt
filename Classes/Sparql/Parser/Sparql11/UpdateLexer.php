...
class UpdateLexer extends \AntlrLexer {
	...
	// delegates
	/**
	 * @param Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11 $gTokenizer11
	 */
	public $gTokenizer11;
	...
	function __construct($input, $state = null) {
		...
		$this->gTokenizer11 = new Erfurt_Sparql_Parser_Sparql11_Update_Tokenizer11($input, $state);
	...
	function mA() {
		try {
			$_type = UpdateLexer::$A;
			$_channel = UpdateLexer::$DEFAULT_TOKEN_CHANNEL;
			// /Users/roll/Documents/workspace/SparqlGrammar/src/Erfurt_Sparql_Parser_Sparql11_Update.g:14:3: ( 'a' )
			// /Users/roll/Documents/workspace/SparqlGrammar/src/Erfurt_Sparql_Parser_Sparql11_Update.g:15:3: 'a'
			{
				$this->matchChar(97);
			}
	...
	function mTokens() {
		// /Users/roll/Documents/workspace/SparqlGrammar/src/Erfurt_Sparql_Parser_Sparql11_Update.g:1:8: ( A | Tokenizer11. Tokens )
		$alt1 = 2;
		...
		switch ($alt1) {
			case 1 :
				// /Users/roll/Documents/workspace/SparqlGrammar/src/Erfurt_Sparql_Parser_Sparql11_Update.g:1:10: A
				{
				$this->mA();
				}
				break;
			case 2 :
				// /Users/roll/Documents/workspace/SparqlGrammar/src/Erfurt_Sparql_Parser_Sparql11_Update.g:1:12: Tokenizer11. Tokens
				{
