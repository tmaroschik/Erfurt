...
namespace Erfurt\Sparql\Parser\Sparql10;
/***************************************************************
 *  Copyright notice
 *
...
class Sparql10Lexer extends \AntlrLexer {
	...
	function mTokens() {
		...
		if (($LA1_0 == $this->getToken('97'))) {
			...
			if ((($LA1_0 >= $this->getToken('9') && $LA1_0 <= $this->getToken('10')) || $LA1_0 == $this->getToken('13') || ($LA1_0 >= $this->getToken('32') && $LA1_0 <= $this->getToken('36')) || ($LA1_0 >= $this->getToken('38') && $LA1_0 <= $this->getToken('64')) || $LA1_0 == $this->getToken('91') || ($LA1_0 >= $this->getToken('93') && $LA1_0 <= $this->getToken('95')) || ($LA1_0 >= $this->getToken('98') && $LA1_0 <= $this->getToken('125')))) {
				$alt1 = 2;
			}
			else {
