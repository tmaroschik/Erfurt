...
interface PackageManagerInterface extends \Erfurt\Singleton {
	 ...
	 *
	 * @param \Erfurt\Core\Bootstrap $bootstrap
	 * @return void
	 */
	 ...
	 * @return array Array of \Erfurt\Package\PackageInterface
	 * @api
	 */
	public function getPackage($packageKey);

	/**
	 * Returns an array of \Erfurt\Package\PackageInterface objects of all available packages.
	 * A package is available, if the package directory contains valid meta information.
	 *
	 * @return array Array of \Erfurt\Package\PackageInterface
	 * @api
	...
	/**
	 * Returns an array of \Erfurt\PackageInterface objects of all active packages.
